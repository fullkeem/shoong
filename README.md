...
| 1. 회원가입 <br /> 2. 로그인 <br /> 3. 헤더/디테일 헤더 | 1. 교환 디테일 <br /> 2. 밋업 페이지 - 지도 & UI <br /> 3. 네비게이션 바 | 1. 교환 페이지 - 그룹 선택 <br /> 2. 교환 페이지 - 필터링 <br /> 3. 밋업 페이지 - 밋업 리스트 <br /> 4. 프로필 페이지 - 콜렉트 북 | 1. 캐러셀 <br /> 2. 검색 <br /> 3. 밋업 디테일 - 코멘트 |  1. 홈/교환 페이지 - 포토카드 리스트 <br /> 2. 찜 목록 <br /> 3. 푸터 <br /> 4. 제보하기 |
